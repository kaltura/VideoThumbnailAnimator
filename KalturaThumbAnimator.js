function KalturaThumbAnimator () {
  ...
  this.setup = function (thumbClassName, kalturaDomain = '://cfvod.kaltura.com', useLazy = false, lazyFilter = 'blur(3px) grayscale(100%) brightness(130%)') {
    ...
    matches.forEach(function(thumbEl) {
      ...
      thumbEl.setAttribute('knextslice', 0);
  ...
  this.getKThumbData = function (thumbEl) {
    ...
    thumbData.currentSlice = (isNaN(thumbData.currentSlice) ? 0 : thumbData.currentSlice);
  ...
  this.loopthumb = function (vidthumb) {
      ...
      if (thumbData.keeprunning > 0) {
          ...
          if (nextSlice == thumbData.spriteSlices) nextSlice = 0;
  ...
  this.mouseOut = function (e) {
      ...
      vidthumb.style.backgroundPosition = "0% 0%";
      vidthumb.setAttribute('knextslice', 0);
